...
const NewPassword=()=>{
                        ...
                        }, [setemaildata, state]); //adding state to the dependency array. This tells React to run the effect whenever state changes.
                        const [alert, setalert] = useState(false);
                        const [emailboolean, setboolean] = useState({
                          password: false,
                              ...
                              try {
                                ...
                                if (error.response?.status === 400) {
                                  setmessage((prevstate) => ({
                                    ...prevstate,
                                    alerthead: "Something went wrong",
                                  }));
                                  setmessage((prevstate) => ({
                                    ...prevstate,
                                    alertsub: "Try again later",
                                  }));
                                  setalert(true);
                                }
                              }
                            ...
                            <div className="newpass">
                              ...
                              <div className="newpasscontainer">
                                ...
                                <input
                                  ...
                                  onChange={handleChange}
                                  className="forgot-input input"
                                  disabled={emailboolean.isabled}
                                  placeholder="Enter new password"
                                />
                                {emailboolean.confirmpassword ? (
                                  <span
                                    style={{
                                      color: "red",
                                      display: "block",
                                ...
                                {emailboolean.confirmpasswordregex ? (
                                  <span
                                    style={{
                                      color: "red",
                                      display: "block",
